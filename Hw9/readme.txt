...
Предложения:
- GetReportService преобразовать в цепочку обязанностей, позволит обработать тип файла несколькими объектами.
- PrintReport преобразовать в декоратор, позволит гибко присваивать выводу новые возможости.